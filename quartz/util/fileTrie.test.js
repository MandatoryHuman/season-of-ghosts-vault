  ...
  describe("fromEntries", () => {
    test("nested", () => {
      const trie = FileTrieNode.fromEntries([
        ["index", { title: "Root", slug: "index", filePath: "index.md" }],
        ["folder/file1", { title: "File 1", slug: "folder/file1", filePath: "folder/file1.md" }],
        [
          "folder/index",
          { title: "Folder Index", slug: "folder/index", filePath: "folder/index.md" },
        ],
        ["folder/file2", { title: "File 2", slug: "folder/file2", filePath: "folder/file2.md" }],
        [
