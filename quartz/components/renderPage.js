      ...
      if (blockRef?.startsWith("#^")) {
        ...
        el.children = [
          ...page.htmlAst.children
            ...
            .map((c) => normalizeHastElement(c, slug, transcludeTarget)),
          {
            type: "element",
            tagName: "a",
            properties: {
...
export function renderPage(cfg, slug, componentData, components, pageResources, treeTransforms) {
  ...
  const doc = _jsxs("html", {
    lang: lang,
    dir: direction,
    children: [
      _jsx(Head, { ...componentData }),
      _jsxs("body", {
        "data-slug": slug,
        "data-basepath": basePath,
        children: [
          frame.css && _jsx("style", { dangerouslySetInnerHTML: { __html: frame.css } }),
          _jsx("div", {
            id: "quartz-root",
            class: "page",
